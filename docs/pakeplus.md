...
我在公司从 0 到 1 开发了 crm 系统(react)，小程序(uniapp)，还有游戏控制台(vue)等项目  
...
感恩默默无闻的赞助者，你们的鼓励是我持续开源的动力，我会继续努力，创造更多有价值的产品。
...
PakePlus 没有跟踪统计用户打包的网站，但还是收到了很多用户在交流群中的反馈，以及一些公司在商业使用中的探索交流，
在这里，我挑选了一些案例给大家展示：

-   句乐部（https://julebu.co/）

一个 9K 的开源英语学习项目，让你上瘾的英语学习工具，项目作者崔老师使用 PakePlus 打包了一下，让句乐部更加专业化，用户使用起来更方便了。

-   奇妙工具箱（https://www.magicalapk.com/toolbox）

奇妙工具箱致力于为用户提供一站式数字生活解决方案，集成了众多实用工具，让您的数字生活更加便捷高效。告别繁琐的多个应用，一个工具箱满足您的所有需求！在他们的官网可以直接下载体验使用 PakePlus 打包后的软件哦。

-   轻媒

轻媒婚恋是一家专为苏州地区白领、知识阶层以及高端精英成功认识离异征婚交友的媒体平台，之前电脑端和移动端都是网站的形式，现在使用 PakePlus 打包后，有了自己的桌面端和移动端 APP，用户满意度和体验更好了。

因为 PakePlus 支持注入自定义 js 脚本，还有更多自定义的项目，用户使用 js 脚本给网站增加了网站换肤和语言翻译等功能，甚至还有自动化操作的功能，但这些是用户打包后自己使用的，不方便展示，也期待你能使用这个功能，创造出属于你自己的专属 APP。
